...
$edit=array();
 ...
 $edit['hr_type']=date("a",strtotime($record['ses_start_time']));
  ...
  $sql.=" bilingual_test='".@$bilingual_test."', ";
...
if(empty($teacher))
{
  ...
  . "int_teacher_id='0',int_school_id='$school_id', "
...
# Update Tutor Board 
  ...
  header("Location:edit_session_success.php?sid=".$_GET['sid']); exit; 
                ...
                <div id="single_question" class="content_wrap">
                    ...
                    <div class="ct_display clear">
                        ...
                        <?php include "msg_inc_1.php";?>
                            ...
                            <h4 title="Edit Session:">Edit Session:</h4>
...
<!--                            <label for="lesson_name">Choose (1-8)students:</label>-->
                            ...
                            <div class="add_question_wrap clear fullwidth">
                                ...
                                <p>
                     <label for="lesson_name">Tutor/Instructor Certification Required:</label>
                                   </p>
                                  
                                   <select name="ses_language" id="ses_language"   class="textbox" onchange="javascript:if(this.value == 1) { $('#certificate_area').show(); $('#lesson_submit').attr('onclick', 'return confirm(\'Are you sure of these requirements associate with the teacher certificate and bilingual? \')');} else { $('#certificate_area').hide(); $('#lesson_submit').removeAttr('onclick');}">
                                         <option value="1" <?php if(!empty($record['bilingual_test']) || !empty($record['certificate'])) { ?> selected <?php } ?>> Yes </option>
                                         <option value="0" <?php if(empty($record['bilingual_test']) && empty($record['certificate'])) { ?> selected <?php } ?>> No </option>
                                    </select>
                                   
                                   <div id="certificate_area" <?php if(!empty($record['bilingual_test']) || !empty($record['certificate'])) { ?> style="display:block" <?php } else { ?> style="display:none" <?php } ?>>
                                   <div class="radio" >
                                    <label>
                                      <input type="radio" name="certificate" id="optionsRadios1" value="1" <?php if(!empty($record['bilingual_test'])) { echo 'checked'; }?>>
                                     Bilingual Tutor ( Spanish )
                                    </label>
                                  </div>
                                  <div class="radio">
                                    <label>
                                      <input type="radio" name="certificate" id="optionsRadios2" value="2" <?php if($record['certificate'] == 2) { echo 'checked'; }?>>
                                      Certified Teacher
                                    </label>
                                  </div>
                                  <div class="radio ">
                                    <label>
                                      <input type="radio" name="certificate" id="optionsRadios3" value="3" <?php if($record['certificate'] == 3) { echo 'checked'; }?>>
                                      Certified Teacher in ESL
                                    </label>
                                  </div>
                                   <div class="radio ">
                                    <label>
                                      <input type="radio" name="certificate" id="optionsRadios4" value="4" <?php if($record['certificate'] == 4) { echo 'checked'; }?>>
                                      Certified Teacher in ESL with Bilingual Tutor ( Spanish )
                                    </label>
                                  </div>
                                       </div>
                                                            </div>
                            ...
                            <option  <?= $sel ?> value="<?= $k ?>"><?= $kff ?></option> 
                              ...
                              <?php $k = $k + 5;
                                ...
                                <div class="row"  id="repeat_id"></div></div><p>
                                  ...
                                  id="lesson_submit" class="form_button" value="" onclick="return confirm('Are you sure of these requirements associate with the teacher certificate and bilingual? ')">Save</button>
